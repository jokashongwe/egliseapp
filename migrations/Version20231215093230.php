 ...
 */
final class Version20231215093230 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE culte (id INT AUTO_INCREMENT NOT NULL, type_culte_id INT DEFAULT NULL, libelle VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', dateculte DATE NOT NULL, effectif INT NOT NULL, nouveau_venu INT DEFAULT NULL, INDEX IDX_7317B14FAE75327C (type_culte_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
